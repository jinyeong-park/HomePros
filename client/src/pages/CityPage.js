...
export function CityPage() {
  ...
  return (
    <>
      ...
      <div className="container" style={{ display: 'flex', padding: '15px', overflowX: 'hidden' }}>
        <div className="chart-container" style={{ flex: '1', marginLeft: '2%', marginRight: '2%', marginBottom: '40px' }}>
